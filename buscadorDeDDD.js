function buscadorDeDDD(ddd) {
  const dddList = [
    ...
    { ddd: 62, estado: "Goiás" },
    { ddd: 63, estado: "Tocantins" },
    { ddd: 64, estado: "Goiás" },
    { ddd: 65, estado: "Mato Grosso" },
    { ddd: 66, estado: "Mato Grosso" },
    { ddd: 67, estado: "Mato Grosso do Sul" },
    { ddd: 68, estado: "Acre" },
    { ddd: 69, estado: "Rondônia" },
    { ddd: 71, estado: "Bahia" },
    { ddd: 73, estado: "Bahia" },
    { ddd: 74, estado: "Bahia" },
    { ddd: 75, estado: "Bahia" },
  ...
  const dddEstado = dddList.find((dddItem) => dddItem.ddd === ddd);

  if (dddEstado) {
    return dddEstado.estado;
  }
